...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/harvester-docs/flexsearch.min.js');loadScript('/harvester-docs/en.search-data.min.4bab66a6d69260652644e80206ec5391df1a3eb5c8d1152f6c1bbf3fa8bd2061.js',function(){input.required=false;search();});}
