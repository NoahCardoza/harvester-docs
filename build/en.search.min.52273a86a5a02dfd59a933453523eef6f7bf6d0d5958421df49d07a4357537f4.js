...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.778b437550dd111ba3dce13208956aa505d9830030a57457234db56be7deedec.js',function(){input.required=false;search();});}
