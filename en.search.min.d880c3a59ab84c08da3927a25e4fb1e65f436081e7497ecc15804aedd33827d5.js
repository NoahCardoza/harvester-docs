...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/harvester-docs/flexsearch.min.js');loadScript('/harvester-docs/en.search-data.min.4e905d548732535797883be137c93b5660c9c82e94e04a0c734756817cb5e099.js',function(){input.required=false;search();});}
