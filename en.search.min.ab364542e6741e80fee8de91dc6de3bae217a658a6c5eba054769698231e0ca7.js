...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/harvester-docs/flexsearch.min.js');loadScript('/harvester-docs/en.search-data.min.cac8d9bed394700e0ff45275bf578008be8bdadac2e30b7c71af0b69cf411d08.js',function(){input.required=false;search();});}
