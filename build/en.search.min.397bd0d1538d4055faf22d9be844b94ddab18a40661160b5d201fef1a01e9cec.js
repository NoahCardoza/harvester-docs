...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.03c219fc901b97035357c006773721fb45db6a8464314738fd84fb06406de4be.js',function(){input.required=false;search();});}
