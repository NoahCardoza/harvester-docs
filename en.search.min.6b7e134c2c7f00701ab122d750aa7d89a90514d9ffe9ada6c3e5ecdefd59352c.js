...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/harvester-docs/flexsearch.min.js');loadScript('/harvester-docs/en.search-data.min.c60114939c77470cee8cea51cf9f82c2c93c6bf04d990479e3bd18aca5f31b70.js',function(){input.required=false;search();});}
